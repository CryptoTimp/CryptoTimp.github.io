...
*/
  ...
  async cancel_all(){
    return await this.request(`private/cancel_all`,{})
  ...
  async getPosition(instrument) {
    return await this.request(`private/get_position`,
        ...
        .catch((error) => {
          ...
          throw new Error(`Could not return after getPosition()`, error);
        });
  }
  async get_position(instrument) {
    return await this.request(`private/get_position`,
        {
          'instrument_name': instrument
        })
  ...
  async edit_order(orderId, orderSizeUSD, price = false, stopPrice = false) {
  ...
  async disable_api_key(id){
    return await this.request("private/disable_api_key",
    {
      'id': id
    }).catch(e => {
      this.log(`Could not return after disable_api_key() Error: `, e);
      throw new Error(`Could not return after disable_api_key()`);
    });
    
  }
  async enable_api_key(id){
    return await this.request("private/enable_api_key",
    {
      'id': id
    }).catch(e => {
      this.log(`Could not return after enable_api_key() Error: `, e);
      throw new Error(`Could not return after enable_api_key()`);
    });
    
  }
  async get_margins(instrument_name, amount, price){
    return await this.request("private/get_margins",
    {
