...
async function updateTable(orderbook) {
    ...
    try {
        ...
        for (var i = centrePrice + 10; i > centrePrice - 10; i -= consolidation) {
...
const socketApi = new SocketClient(`ws/linkusdt@depth@100ms`, 'wss://fstream3.binance.com/');
...
var volumeProfileObject = {} //   prices : qty (denoted in link)
var price
var rawprice
