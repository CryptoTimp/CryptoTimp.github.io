...
function RenderBinanceTOS() {
    ...
    BinanceTOSTable += `<tr id = "row00" > <th colspan="3"><img src="binance_futures.svg" width="10" height="10"> BTCUSDT</th>`
    ...
    for (var i = BinanceTOSData.length - 1; i >= 0; i--) {
        ...
        // Add data
        BinanceTOSTable += `<tr> <td style="background-color:${colour}; color:${textColour};"> ${Number(BinanceTOSData[i].p).toFixed(0)}</td><td style="background-color:${colour}; color:${textColour};"> ${size}</td>${directionColour}</tr>`
